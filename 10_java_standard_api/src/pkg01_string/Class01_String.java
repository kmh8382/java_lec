...
public class Class01_String {
  ...
  public static void practice01() {
    ...
    int spaceIndex = uri.indexOf(contextPath);
    System.out.println(spaceIndex);
    System.out.println(uri.substring(spaceIndex + 8));
  ...
  public static void practice02() {
    ...
    for(int i = 0; i < word.length() / 2; i++) {
      str1 = word.charAt(i);
      str2 = word.charAt(strLen);
      System.out.println(i + "번째 : " + str1 + "  " + strLen + "번째 : " + str2);
