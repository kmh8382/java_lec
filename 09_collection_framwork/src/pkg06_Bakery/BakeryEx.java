...
public class BakeryEx {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("bakery1 : " + bakery1.getBread() + ", " + bakery1.getMoney());
    System.out.println("bakery2 : " + bakery2.getBread() + ", " + bakery2.getMoney());
    System.out.println("customer : " + customer.getBread() + ", " + customer.getMoney());
